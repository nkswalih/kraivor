import json
import logging
from app.application.agents.prompts.orchestrator import ORCHESTRATOR_SYSTEM_PROMPT, RESPOND_DIRECT_PROMPT
...
class OrchestratorNode:
    ...
    async def __call__(self, state: dict) -> dict:
        ...
        if intent in DIRECT_INTENTS and not needs_context and not needs_rag:
            respond_route = self.router.get_route("simple_qa")
            ...
            messages.append({"role": "system", "content": RESPOND_DIRECT_PROMPT})
