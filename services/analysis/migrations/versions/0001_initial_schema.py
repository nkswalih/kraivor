...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "trigger_type", sa.String(20), server_default="manual", nullable=True
        ),
        sa.Column("repo_url", sa.Text(), nullable=True),
        sa.Column("branch", sa.String(255), server_default="main", nullable=True),
        sa.Column(
            "deep_scan", sa.Boolean(), server_default=sa.text("true"), nullable=True
        ),
        sa.Column(
            "simulate_users",
            sa.ARRAY(sa.Integer()),
            server_default=sa.text("'{100,500,5000}'"),
            nullable=True,
        ),
        ...
        sa.Column(
            "total_findings", sa.Integer(), server_default=sa.text("0"), nullable=True
        ),
        sa.Column(
            "critical_count", sa.Integer(), server_default=sa.text("0"), nullable=True
        ),
        sa.Column(
            "high_count", sa.Integer(), server_default=sa.text("0"), nullable=True
        ),
        sa.Column(
            "medium_count", sa.Integer(), server_default=sa.text("0"), nullable=True
        ),
        sa.Column(
            "low_count", sa.Integer(), server_default=sa.text("0"), nullable=True
        ),
    ...
    op.create_index(
        "idx_jobs_triggered_by", "analysis_jobs", ["triggered_by"], schema="analysis"
    )
    ...
    op.create_index(
        "idx_results_job", "analysis_results", ["job_id"], schema="analysis"
    )
    op.create_index(
        "idx_results_repo", "analysis_results", ["repo_id"], schema="analysis"
    )
    op.create_index(
        "idx_results_category",
        "analysis_results",
        ["repo_id", "category"],
        schema="analysis",
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "confidence", sa.Numeric(3, 2), server_default=sa.text("0.0"), nullable=True
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_index(
        "idx_dead_code_type", "dead_code", ["repo_id", "code_type"], schema="analysis"
    )
    op.create_index(
        "idx_dead_code_file", "dead_code", ["repo_id", "file_path"], schema="analysis"
    )
    ...
    op.create_index(
        "idx_perf_job", "performance_metrics", ["job_id"], schema="analysis"
    )
    op.create_index(
        "idx_perf_repo", "performance_metrics", ["repo_id"], schema="analysis"
    )
    ...
    op.create_table(
        ...
        sa.Column("devops_score", sa.SmallInteger(), nullable=True),
        sa.Column(
            "findings_count", sa.Integer(), server_default=sa.text("0"), nullable=True
        ),
    ...
    op.create_index(
        "idx_score_history_repo",
        "score_history",
        ["repo_id", sa.text("time DESC")],
        schema="analysis",
    )
    op.create_index(
        "idx_score_history_workspace",
        "score_history",
        ["workspace_id", sa.text("time DESC")],
        schema="analysis",
    )
    ...
    op.create_index(
        "idx_guides_job", "enterprise_guides", ["job_id"], schema="analysis"
    )
    op.create_index(
        "idx_guides_repo", "enterprise_guides", ["repo_id"], schema="analysis"
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "job_id",
            sa.Uuid(),
            sa.ForeignKey("analysis.analysis_jobs.id"),
            nullable=True,
        ),
        sa.Column("workspace_id", sa.Uuid(), nullable=False),
