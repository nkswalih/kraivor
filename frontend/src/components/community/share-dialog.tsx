      ...
      >
        ...
        <div className="p-5 space-y-4">
          <div className="space-y-2">
            <p className="text-[11px] font-medium text-muted-foreground uppercase tracking-wider">Share via</p>
            <div className="grid grid-cols-4 gap-3">
              ...
              <a
                ...
                className="flex flex-col items-center gap-1.5 p-3 rounded-lg bg-muted/50 hover:bg-muted transition-colors"
              >
                <svg className="w-5 h-5 text-muted-foreground" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
          ...
          <div className="pt-2 border-t border-border">
            <p className="text-[11px] font-medium text-muted-foreground uppercase tracking-wider mb-2">Send to team member</p>
            <TeamMemberSearch discussionId={discussionId} />
          </div>

          <div className="pt-2 border-t border-border">
            <p className="text-[11px] font-medium text-muted-foreground uppercase tracking-wider mb-2">Link</p>
            <button
              onClick={async () => {
...
function TeamMemberSearch({ discussionId }: { discussionId: string }) {
  ...
  const [selected, setSelected] = useState<{ id: string; name: string; avatar_url?: string } | null>(null);
