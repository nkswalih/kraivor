...
def downgrade() -> None:
    op.drop_index("idx_reliability_type", table_name="reliability_findings", schema="analysis")
    op.drop_index("idx_reliability_job", table_name="reliability_findings", schema="analysis")
