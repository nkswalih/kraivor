...
import { BookOpen, Plus, Loader2, Search, ExternalLink, Trash2, MoreHorizontal, Check, X } from 'lucide-react';
import { useParams, useRouter } from 'next/navigation';
import { useAuthStore } from '@/lib/stores/auth-store';
import { useKnowledgeList, useDeleteKnowledge, useUpdateKnowledge } from '@/lib/hooks/use-knowledge';
...
function KnowledgeCard({ space, workspaceSlug }: { space: { id: string; name: string; description: string | null; created_at: string; updated_at: string }; workspaceSlug: string }) {
    ...
    >
      <div className="flex items-start justify-between mb-1">
        ...
        <div className="flex items-center gap-1 shrink-0" onClick={e => e.stopPropagation()}>
          <ExternalLink
            onClick={e => { e.stopPropagation(); router.push(`/${workspaceSlug}/knowledge/${space.id}`); }}
