        ...
        <section className="container mx-auto px-6 pt-12 pb-20 text-center">
          <div className="animate-fade-up mx-auto max-w-4xl">
            ...
            <p className="text-xl text-slate-400 leading-relaxed mb-12">
              ...
              It is not three separate products loosely bolted together — it is one platform where
              all three products share infrastructure, authentication, user identity, and workspace
              context.
            </p>
          </div>
        </section>
            ...
            {[
              {
                ...
                desc: 'All traffic — web, mobile, CLI — enters through one API Gateway. No service is ever exposed directly to the internet.',
              },
              {
                icon: Icons.Async,
                title: 'Async by Default',
                desc: 'Any operation taking >500ms is a background job. Results are pushed via WebSocket. This allows 10,000+ concurrent users seamlessly.',
              },
              {
                icon: Icons.Database,
                title: 'Service Owns its Data',
                desc: 'Each microservice has its own schema. Data sharing happens exclusively through APIs or events, never shared database queries.',
              },
              {
                icon: Icons.Shield,
                title: 'Fail Gracefully',
                desc: 'If the AI service is down, the analyzer works. Each product degrades independently, never taking down the whole platform.',
              },
              {
                icon: Icons.Eye,
                title: 'Everything is Observable',
                desc: 'Every request has a correlation ID. Every service emits structured logs. You can trace any problem through every layer.',
              },
            ].map((principle, idx) => (
              <RevealSection key={idx} delay={`delay-[${idx * 100}ms]`}>
                <div className="group relative h-full rounded-2xl border border-white/10 bg-white/[0.02] p-8 backdrop-blur-md transition-all duration-300 hover:bg-white/[0.04] hover:border-[hsl(var(--primary))/40] hover:shadow-[0_8px_32px_-10px_hsla(var(--primary),0.3)] hover:-translate-y-1">
                  ...
                  <h3 className="mb-3 text-lg font-bold text-white group-hover:text-[hsl(var(--primary-light))] transition-colors">
                    {principle.title}
                  </h3>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-lg text-slate-400 leading-relaxed mb-6">
                  The core product. This is what makes Kraivor valuable on day one. Connect your
                  GitHub or GitLab repository, and Kraivor analyzes the entire codebase — evaluating
                  folder architecture, code quality patterns, DevOps maturity, security posture, and
                ...
                <div className="bg-white/5 border border-white/10 rounded-xl p-6 backdrop-blur-sm relative overflow-hidden">
                  ...
                  <p className="text-sm text-slate-300">
                    Rule-based static analysis combined with AI-powered contextual understanding.
                    Rules catch definite problems; the AI catches architectural intent that rules
                    cannot.
                  </p>
                </div>
              </div>
              ...
              <div className="relative aspect-square md:aspect-[4/3] rounded-3xl border border-white/10 bg-gradient-to-br from-white/5 to-transparent flex items-center justify-center overflow-hidden shadow-2xl shadow-[hsl(var(--primary))]/5">
                ...
                <div className="relative z-10 w-3/4 space-y-4">
                  {[85, 92, 78].map((score, i) => (
                    <div
                      key={i}
                      className="bg-[#0a0a0f] border border-white/10 rounded-xl p-4 flex items-center justify-between shadow-lg"
                    >
                      <div className="h-2 w-24 bg-white/10 rounded-full overflow-hidden">
                        <div
                          className="h-full bg-[hsl(var(--primary-light))]"
                          style={{ width: `${score}%` }}
                        />
                      </div>
          ...
          <RevealSection>
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="order-1 lg:order-2">
                ...
                <p className="text-lg text-slate-400 leading-relaxed mb-6">
                  A multi-agent AI workspace where developers interact with their codebase through
                  intelligent agents. Not a chatbot. Not a code autocomplete. A system of
                  specialized AI agents that collaborate to answer complex engineering questions.
                </p>
                <div className="bg-white/5 border border-white/10 rounded-xl p-6 backdrop-blur-sm relative overflow-hidden">
                  <div className="absolute left-0 top-0 w-1 h-full bg-[hsl(var(--primary))]" />
                  <h4 className="text-white font-bold mb-2">Key Differentiator</h4>
                  <p className="text-sm text-slate-300">
                    2026-standard agentic behavior. Agents have memory, can call tools, search the
                    codebase, and collaborate autonomously. The Orchestrator decides which agents to
                    involve, and the Explainer Agent synthesizes actionable results.
                  </p>
                </div>
              </div>
            </div>
          ...
          <RevealSection>
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-lg text-slate-400 leading-relaxed mb-6">
                  The daily driver. Developers live in Kraivor because it replaces their scattered
                  workflow. Notes in Notion, tasks in Linear, architecture diagrams in Miro,
                  decisions in Slack — Kraivor unifies these with AI that knows your codebase.
                </p>
                <div className="bg-white/5 border border-white/10 rounded-xl p-6 backdrop-blur-sm relative overflow-hidden">
                  <div className="absolute left-0 top-0 w-1 h-full bg-[hsl(var(--primary))]" />
                  <h4 className="text-white font-bold mb-2">Key Differentiator</h4>
                  <p className="text-sm text-slate-300">
                    Context continuity. Every note, task, and architectural decision is indexed
                    alongside the codebase. When you ask the AI a question, it never loses context
            ...
            <div className="relative rounded-3xl border border-white/10 bg-white/[0.02] p-12 text-center backdrop-blur-xl overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-lg text-slate-400 mb-10 max-w-2xl mx-auto">
                  Stop context switching between fragmented tools. Join Kraivor and build with
                  production-grade intelligence.
                </p>
                <Link
                  href={ROUTES.REGISTER}
                  className="btn-shimmer inline-flex items-center justify-center rounded-xl px-10 py-4 text-base font-semibold text-white shadow-[0_0_40px_-10px_hsl(var(--primary))]"
                >
