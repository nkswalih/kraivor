...
urlpatterns = [
    ...
    path('api/oauth/github/connect/', GitHubOAuthConnectView.as_view(), name='github-oauth-connect'),
    path('api/github-app/callback/', GitHubAppInstallCallbackView.as_view(), name='github-app-install-callback'),
