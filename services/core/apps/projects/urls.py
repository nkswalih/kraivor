...
urlpatterns = [
    path("workspaces/<uuid:workspace_pk>/projects/", views.ProjectListCreateView.as_view(), name="project-list-create"),
    path("workspaces/<uuid:workspace_pk>/projects/<uuid:project_id>/", views.ProjectDetailView.as_view(), name="project-detail"),
    path("workspaces/<uuid:workspace_pk>/projects/<uuid:project_id>/tasks/", views.ProjectTaskListView.as_view(), name="project-task-list"),
    path("workspaces/<uuid:workspace_pk>/projects/<uuid:project_id>/ai/recommendations/", views.ProjectAIRecommendationsView.as_view(), name="project-ai-recommendations"),
    path("workspaces/<uuid:workspace_pk>/tasks/", views.TaskListCreateView.as_view(), name="task-list-create"),
    path("workspaces/<uuid:workspace_pk>/tasks/<uuid:task_id>/", views.TaskDetailView.as_view(), name="task-detail"),
    path("workspaces/<uuid:workspace_pk>/tasks/<uuid:task_id>/status/", views.TaskStatusUpdateView.as_view(), name="task-status-update"),
